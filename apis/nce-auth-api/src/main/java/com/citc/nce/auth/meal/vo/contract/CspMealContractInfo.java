 ...
 **/
@Data
@ApiModel(value = "CspMealContractInfo对象", description = "csp用户套餐表")
public class CspMealContractInfo {
    @ApiModelProperty("主键")
    ...
    @ApiModelProperty("基础套餐")
    private CspContractMeal basicMeal;

    @ApiModelProperty("扩容套餐")
    private List<CspContractMeal> expansionMeal;
}
