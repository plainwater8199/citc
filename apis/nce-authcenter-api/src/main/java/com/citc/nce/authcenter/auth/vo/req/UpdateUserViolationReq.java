...
@Data
public class UpdateUserViolationReq {
    ...
    @ApiModelProperty(value = "违规类型:默认-0",dataType = "Integer",required = true)
    private Integer violationType;

    @NotNull(message = "是否为撤销不能为空！")
    @ApiModelProperty(value = "是否撤销-撤销该类型违规-1",dataType = "Integer",required = true)
