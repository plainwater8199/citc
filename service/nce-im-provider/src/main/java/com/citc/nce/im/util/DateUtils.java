...
//        System.out.println(obtainWeek(obtainDate("2022-1-3 12:00:00")));
    ...
    public static Object getTodayStart() {
        Calendar calendar = Calendar.getInstance();
    ...
    public static Object getTodayEnd() {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(new Date());
    ...
    public static Object getTomorrowEnd() {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(new Date());
        calendar.add(Calendar.DAY_OF_YEAR, 1); // 在当前时间基础上加一天
        calendar.set(Calendar.HOUR_OF_DAY, 23);
        calendar.set(Calendar.MINUTE, 59);
        calendar.set(Calendar.SECOND, 59);
        calendar.set(Calendar.MILLISECOND, 999);
    ...
    public static Date LocalDateTimeToDate(LocalDateTime settingTime) {
        return Date.from(settingTime.atZone(ZoneId.systemDefault()).toInstant());
    }
}
