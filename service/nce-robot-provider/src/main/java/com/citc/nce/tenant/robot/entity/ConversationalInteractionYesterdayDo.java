...
@TableName("conversational_interaction_yesterday")
@ApiModel(value = "ConversationalInteractionYesterday对象", description = "昨日会话用户统计表")
public class ConversationalInteractionYesterdayDo extends BaseDo<ConversationalInteractionYesterdayDo> implements Serializable {
