...
@TableName("conversational_interaction_weeks")
@ApiModel(value = "ConversationalInteractionWeeks对象", description = "每周会话用户统计表")
public class ConversationalInteractionWeeksDo extends BaseDo<ConversationalInteractionWeeksDo> implements Serializable {
