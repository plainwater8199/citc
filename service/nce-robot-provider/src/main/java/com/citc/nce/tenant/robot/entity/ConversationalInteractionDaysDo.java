...
@TableName("conversational_interaction_days")
@ApiModel(value = "ConversationalInteractionDays对象", description = "每天会话用户统计表")
public class ConversationalInteractionDaysDo extends BaseDo<ConversationalInteractionDaysDo> implements Serializable {
