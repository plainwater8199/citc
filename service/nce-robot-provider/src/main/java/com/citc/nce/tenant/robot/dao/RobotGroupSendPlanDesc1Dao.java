...
import com.citc.nce.tenant.robot.entity.RobotGroupSendPlanDescDo;
 ...
 * @Version: 1.0
 */
public interface RobotGroupSendPlanDesc1Dao extends BaseMapperX<RobotGroupSendPlanDescDo> {
