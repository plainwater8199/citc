...
@TableName("process_quantity_statistic")
@ApiModel(value = "ProcessQuantityStatistic对象", description = "流程统计表")
public class ProcessQuantityStatisticDo extends BaseDo<ProcessQuantityStatisticDo> implements Serializable {
