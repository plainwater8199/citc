...
@TableName("process_quantity_yesterday")
@ApiModel(value = "ProcessQuantityYesterday对象", description = "昨日流程统计表")
public class ProcessQuantityYesterdayDo extends BaseDo<ProcessQuantityYesterdayDo> implements Serializable {
