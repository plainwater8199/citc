package com.citc.nce.auth.csp.mediasms.template.dao;
 ...
 * @author jiancheng
 */
public interface MediaSmsTemplateMapper extends BaseMapper<MediaSmsTemplateDo> {
    ...
    List<MediaSmsHaveTemplateAccountVo> getHaveTemplateAccountsByUserId(@Param("customerId")String customerId);
}
